---
title: "shiyu-coder/Kronos — 최신 이슈 1개 리뷰"
date: "2026-04-13"
...
- 오늘 트렌딩: **shiyu-coder/Kronos** (Python · ⭐ 16,065)
- 고른 이슈: **[Question] How to load pre-trained models from HuggingFace? Missing config.json** (open · 2026-04-13)
- 링크: https://github.com/shiyu-coder/Kronos/issues/240

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: Hi @shiyu-coder, Thank you for open-sourcing Kronos! I'm trying to load pre-trained models from HuggingFace Hub but encountered an issue. ### Problem When calling: ```python from model import Kronos, KronosTokenizer tok…
...
이 프로젝트는 "Kronos: A Foundation Model for the Language of Financial Markets" 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 
