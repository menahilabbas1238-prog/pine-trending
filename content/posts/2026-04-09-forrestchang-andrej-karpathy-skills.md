---
title: "forrestchang/andrej-karpathy-skills — 최신 이슈 1개 리뷰"
date: "2026-04-09"
repo: "forrestchang/andrej-karpathy-skills"
repoUrl: "https://github.com/forrestchang/andrej-karpathy-skills"
description: "Daily GitHub Trending review for forrestchang/andrej-karpathy-skills"
tags: ["trending", "daily"]
---

## TL;DR

- 오늘 트렌딩: **forrestchang/andrej-karpathy-skills** (언어 미상 · ⭐ 9,210)
- 고른 이슈: **Option A install command Claude plugin adoes not work** (open · 2026-02-14)
- 링크: https://github.com/forrestchang/andrej-karpathy-skills/issues/23

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: The README's Option A install command does not work: claude plugins add https://github.com/forrestchang/andrej-karpathy-skills Running this command results in an error because claude plugins add is not a valid Claude Co…
...
이 프로젝트는 기능 대비 관심이 붙은 상태라, 이슈 대응 속도가 곧 신뢰도로 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 2개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 
