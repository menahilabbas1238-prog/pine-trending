---
title: "usekaneo/kaneo — 최신 이슈 1개 리뷰"
date: "2026-08-03"
repo: "usekaneo/kaneo"
...
- 오늘 트렌딩: **usekaneo/kaneo** (TypeScript · ⭐ 6,302)
- 고른 이슈: **[Bug]: "Overdue" and "due-soon" date badges still show on tasks in the "Done" column** (open · 2026-08-02)
- 링크: https://github.com/usekaneo/kaneo/issues/1465

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ### Bug Description Tasks in the "Done" column keep showing the "overdue" (red) or "due-soon" (yellow) due date badge once their due date has passed or is close to the due date. A finished task has nothing else to be do…
...
이 프로젝트는 "🎯 All you need. Nothing you don't. Open source project management that works for you, not against you." 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 1개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨은 `bug`가 붙어있어서 분류는 어느 정도 되어 보임. 
