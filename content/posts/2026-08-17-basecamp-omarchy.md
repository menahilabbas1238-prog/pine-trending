---
title: "basecamp/omarchy — 최신 이슈 1개 리뷰"
date: "2026-08-17"
repo: "basecamp/omarchy"
repoUrl: "https://github.com/basecamp/omarchy"
...
- 오늘 트렌딩: **basecamp/omarchy** (Shell · ⭐ 25,453)
- 고른 이슈: **Laptop display stays dark after disconnecting from External Display** (open · 2026-08-17)
- 링크: https://github.com/basecamp/omarchy/issues/7209

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ### System details Thinkpad E14 Gen 7, Omarchy Quattro ### What's wrong? First time user of Omarchy so I'm not sure if previous versions had this problem as well. Sequence of events was - Plug into external monitor - Se…
...
이 프로젝트는 "Beautiful, Modern & Opinionated Linux" 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨은 `bug`가 붙어있어서 분류는 어느 정도 되어 보임. 

---

참고: https://omarchy.org
