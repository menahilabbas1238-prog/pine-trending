---
title: "multica-ai/andrej-karpathy-skills — 최신 이슈 1개 리뷰"
date: "2026-05-22"
...
- 오늘 트렌딩: **multica-ai/andrej-karpathy-skills** (언어 미상 · ⭐ 143,768)
- 고른 이슈: **(이 레포에는 최근 이슈가 안 보였음)** (unknown)
- 링크: https://github.com/multica-ai/andrej-karpathy-skills
...
이 프로젝트는 "A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM coding pitfalls." 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 
