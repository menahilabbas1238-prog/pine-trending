---
title: "FujiwaraChoki/MoneyPrinterV2 — 최신 이슈 1개 리뷰"
date: "2026-03-22"
repo: "FujiwaraChoki/MoneyPrinterV2"
repoUrl: "https://github.com/FujiwaraChoki/MoneyPrinterV2"
...
- 오늘 트렌딩: **FujiwaraChoki/MoneyPrinterV2** (Python · ⭐ 17,931)
- 고른 이슈: **feat: add OpenRouter as cloud LLM provider** (open · 2026-03-22)
- 링크: https://github.com/FujiwaraChoki/MoneyPrinterV2/issues/148

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ### Problem MPV2 currently only supports Ollama for LLM text generation. This requires running a local Ollama server, which is a setup barrier for many users. On #139, you mentioned it would be smarter to add OpenRouter…
...
이 프로젝트는 "Automate the process of making money online." 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 1개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 
