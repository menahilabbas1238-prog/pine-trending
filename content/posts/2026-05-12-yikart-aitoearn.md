---
title: "yikart/AiToEarn — 최신 이슈 1개 리뷰"
date: "2026-05-12"
repo: "yikart/AiToEarn"
repoUrl: "https://github.com/yikart/AiToEarn"
...
- 오늘 트렌딩: **yikart/AiToEarn** (TypeScript · ⭐ 11,046)
- 고른 이슈: **Docuker本地部署，使用AI写作助手调用的不是我配置的大模型，而是：https://aitoearn.ai/api/ai/chat** (open · 2026-05-11)
- 링크: https://github.com/yikart/AiToEarn/issues/507

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ### Self Checks - [x] I have read the [Contributing Guide](https://github.com/yikart/AiToEarn/blob/main/CONTRIBUTING.md). - [x] I have searched for existing issues [search for existing issues](https://github.com/yikart/…
...
이 프로젝트는 "Let's use AI to Earn!" 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨은 `bug`가 붙어있어서 분류는 어느 정도 되어 보임. 

---

참고: https://aitoearn.ai/
