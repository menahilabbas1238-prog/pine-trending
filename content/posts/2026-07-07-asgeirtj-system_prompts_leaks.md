---
title: "asgeirtj/system_prompts_leaks — 최신 이슈 1개 리뷰"
date: "2026-07-07"
...
- 오늘 트렌딩: **asgeirtj/system_prompts_leaks** (JavaScript · ⭐ 51,856)
- 고른 이슈: **Hi16** (open · 2026-07-06)
- 링크: https://github.com/asgeirtj/system_prompts_leaks/issues/159

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ![image](https://github.com/user-attachments/assets/dcea2b0d-c74c-4f
...
이 프로젝트는 "Extracted system prompts from Anthropic - Claude Fable 5, Opus 4.8, Claude Code, Claude Design. OpenAI - ChatGPT 5.5 Thinking, GPT 5.5 Instant, Codex. Google - Gemini 3.5 Flash, 3.1 Pro, Antigravity. xAI - Grok, Cursor, Copilot, VS Code, Perplexity, and more. Updated regularly." 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 

---

참고: https://asgeirtj.github.io/system_prompts_leaks/
