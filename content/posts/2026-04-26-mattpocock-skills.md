---
title: "mattpocock/skills — 최신 이슈 1개 리뷰"
date: "2026-04-26"
...
- 오늘 트렌딩: **mattpocock/skills** (Shell · ⭐ 20,378)
- 고른 이슈: **Any ideas on how to adjust /to-issue such that when agent pickup it implements it using /tdd** (open · 2026-04-24)
- 링크: https://github.com/mattpocock/skills/issues/49

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: TDD has the planning phase in the beginning that requires the human in the loop. Has anyone tried adjusting the /to-issue to proactively plan for the /tdd, and what was the experience with the end results?
...
이 프로젝트는 "My personal directory of skills, straight from my .claude directory." 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 3개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 
