---
title: "Leonxlnx/taste-skill — 최신 이슈 1개 리뷰"
date: "2026-05-29"
...
- 오늘 트렌딩: **Leonxlnx/taste-skill** (Shell · ⭐ 26,849)
- 고른 이슈: **refactor: extract appendices to reference/ files** (open · 2026-05-28)
- 링크: https://github.com/Leonxlnx/taste-skill/issues/38

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: SKILL.md currently bundles all reference material (install commands, canonical doc URLs, Liquid Glass CSS) inline as Appendices A/B/C, adding ~224 lines (18%) that are only needed when the agent actually picks a design…
...
이 프로젝트는 "Taste-Skill - gives your AI good taste. stops the AI from generating boring, generic slop " 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 

---

참고: https://tasteskill.dev
