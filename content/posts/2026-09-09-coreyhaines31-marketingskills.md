---
title: "coreyhaines31/marketingskills — 최신 이슈 1개 리뷰"
date: "2026-09-09"
...
- 오늘 트렌딩: **coreyhaines31/marketingskills** (JavaScript · ⭐ 48,957)
...
이 프로젝트는 "Marketing skills for Claude Code and AI agents. CRO, copywriting, SEO, analytics, and growth engineering." 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 

---

참고: https://marketing-skills.com
...
- “재현 → 원인 후보 → 해결 → 회귀 방지(테스트)” 4단계로 이슈를 닫는 흐름을…
