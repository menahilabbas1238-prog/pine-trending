---
title: "TauricResearch/TradingAgents — 최신 이슈 1개 리뷰"
date: "2026-03-23"
...
- 오늘 트렌딩: **TauricResearch/TradingAgents** (Python · ⭐ 37,658)
- 고른 이슈: **Market analyst crashes on unsupported indicator "agt"** (open · 2026-03-23)
- 링크: https://github.com/TauricResearch/TradingAgents/issues/429

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: Error: Indicator agt is not supported. Supported: close_50_sma, close_200_sma, close_10_ema, macd, macds, macdh, rsi, boll, boll_ub, boll_lb, atr, vwma, mfi Ticker: AEP Version: 0.2.2
...
이 프로젝트는 "TradingAgents: Multi-Agents LLM Financial Trading Framework" 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 

---

참고: https://arxiv.org/pdf/2412.20138
