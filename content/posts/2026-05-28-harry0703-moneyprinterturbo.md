---
title: "harry0703/MoneyPrinterTurbo — 최신 이슈 1개 리뷰"
date: "2026-05-28"
...
- 오늘 트렌딩: **harry0703/MoneyPrinterTurbo** (Python · ⭐ 63,192)
- 고른 이슈: **[Bug]: azure_tts_v1 - failed, error: 403** (open · 2026-05-28)
- 링크: https://github.com/harry0703/MoneyPrinterTurbo/issues/901

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ### 问题描述 | Current Behavior 生成视频失败 ### 重现步骤 | Steps to Reproduce 输入关键词 点击生成视频 ### 错误日志 | Error Logs ## generating audio 2026-05-28 10:05:26 | INFO | "./app\services\voice.py:1127": azure_tts_v1 - start, voice name: zh-C…
...
이 프로젝트는 "利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM." 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 1개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨은 `bug`가 붙어있어서 분류는 어느 정도 되어 보임. 
