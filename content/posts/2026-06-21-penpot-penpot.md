---
title: "penpot/penpot — 최신 이슈 1개 리뷰"
date: "2026-06-21"
repo: "penpot/penpot"
...
- 오늘 트렌딩: **penpot/penpot** (Clojure · ⭐ 51,637)
- 고른 이슈: **Translation error** (open · 2026-06-21)
- 링크: https://github.com/penpot/penpot/issues/10346

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ### Steps To Reproduce 1. create a board 2. right menu 3. use "path" ### Expected behavior The correct Chinese (zh-CN) might be "交集". ### Actual behavior The error Chinese (zh-CN) is "差集". ### Screenshots or video <img…
...
이 프로젝트는 "Penpot: The open-source design tool for design and code collaboration" 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 1개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨은 `needs triage`가 붙어있어서 분류는 어느 정도 되어 보임. 
