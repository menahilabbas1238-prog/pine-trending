---
title: "tailscale/tailcat — 최신 이슈 1개 리뷰"
date: "2026-08-30"
repo: "tailscale/tailcat"
repoUrl: "https://github.com/tailscale/tailcat"
...
- 오늘 트렌딩: **tailscale/tailcat** (Go · ⭐ 3,709)
- 고른 이슈: **remove peerapiclient from wasm build** (open · 2026-08-30)
- 링크: https://github.com/tailscale/tailcat/issues/29

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: Once https://github.com/tailscale/tailscale/pull/21037 is merged, bump go.mod and stop including peerapiclient in wasm builds.
...
이 프로젝트는 "like netcat, but over Tailscale's data plane, without Tailscale's control plane" 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 

---

참고: https://tailscale.com/tailcat
