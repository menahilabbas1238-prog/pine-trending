---
title: "agent-substrate/substrate — 최신 이슈 1개 리뷰"
date: "2026-09-23"
repo: "agent-substrate/substrate"
repoUrl: "https://github.com/agent-substrate/substrate"
...
- 오늘 트렌딩: **agent-substrate/substrate** (Go · ⭐ 3,085)
- 고른 이슈: **Harden DNS Relay** (open · 2026-09-23)
- 링크: https://github.com/agent-substrate/substrate/issues/1816

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: We need to follow up https://github.com/agent-substrate/substrate/pull/1689#discussion_r4077377381 to make sure the new DNS relay is hardened. There's been a first pass at this but once we merge and exercise it more + s…
...
이 프로젝트는 "Agent Substrate: the core system" 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨은 `area/network`가 붙어있어서 분류는 어느 정도 되어 보임. 
