---
title: "Open-Dev-Society/OpenStock — 최신 이슈 1개 리뷰"
date: "2026-09-22"
...
- 오늘 트렌딩: **Open-Dev-Society/OpenStock** (TypeScript · ⭐ 17,982)
- 고른 이슈: **[Tech debt] Resolve dormant auth, MongoDB, watchlist and Inngest architecture** (open · 2026-09-22)
- 링크: https://github.com/Open-Dev-Society/OpenStock/issues/98

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ## Context The current public dashboard is local-first and no longer requires authentication, MongoDB or a user account. Legacy watchlist, alert, MongoDB, Inngest and email modules remain in the tree but are not reachab…
...
참고: https://openstock-ods.vercel.app
...
- “재현 → 원인 후보 → 해결 → 회귀 방지(테스트)” 4단계로 이슈를 닫는 흐름을 템플릿화할…
