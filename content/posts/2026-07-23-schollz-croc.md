---
title: "schollz/croc — 최신 이슈 1개 리뷰"
date: "2026-07-23"
repo: "schollz/croc"
...
- 오늘 트렌딩: **schollz/croc** (Go · ⭐ 37,749)
- 고른 이슈: **[Bug]: invalid character** (closed · 2026-07-20)
- 링크: https://github.com/schollz/croc/issues/1171

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ### What happened? ``` [debug] 11:56:28 croc.go:1800: got error processing: problem with decoding: invalid character 'ä' looking for beginning of value [debug] 11:56:28 croc.go:562: transfer attempt 0 failed: problem wi…
...
이 프로젝트는 "Easily and securely send things from one computer to another :crocodile: :package:" 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨은 `bug`가 붙어있어서 분류는 어느 정도 되어 보임. 

---

참고: https://schollz.com/software/croc6
