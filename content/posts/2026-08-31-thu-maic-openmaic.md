---
title: "THU-MAIC/OpenMAIC — 최신 이슈 1개 리뷰"
date: "2026-08-31"
...
- 오늘 트렌딩: **THU-MAIC/OpenMAIC** (TypeScript · ⭐ 24,938)
- 고른 이슈: **[Bug]: Built-in skill loading throws on Windows paths** (open · 2026-08-31)
- 링크: https://github.com/THU-MAIC/OpenMAIC/issues/1295

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ### Bug Description On Windows, the built-in agent skill loader throws before it can return any recursively discovered skill. OpenMAIC pins `@earendil-works/pi-agent-core` 0.78.0; that version's relative-path helper onl…
...
이 프로젝트는 "Open Multi-Agent Interactive Classroom — Get an immersive, multi-agent learning experience in just one click" 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 
