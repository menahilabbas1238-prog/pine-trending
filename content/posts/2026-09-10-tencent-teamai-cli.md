---
title: "Tencent/teamai-cli — 최신 이슈 1개 리뷰"
date: "2026-09-10"
repo: "Tencent/teamai-cli"
repoUrl: "https://github.com/Tencent/teamai-cli"
...
- 오늘 트렌딩: **Tencent/teamai-cli** (TypeScript · ⭐ 3,231)
- 고른 이슈: **docs: fix CONTRIBUTING branch baseline and require dogfooding the public team repo** (open · 2026-09-10)
- 링크: https://github.com/Tencent/teamai-cli/issues/479

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ## Summary `.github/CONTRIBUTING.md` is wrong on the default branch, and it never asks CLI contributors to run TeamAI against a TeamAI team repo (dogfooding / bootstrap). ## Problems 1. **Wrong branch.** "Making a Chang…
...
이 프로젝트는 "Make Every Team AI Native" 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨이 거의 없으면 triage를 먼저 하는 게 좋음. 
