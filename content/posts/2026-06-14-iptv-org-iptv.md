---
title: "iptv-org/iptv — 최신 이슈 1개 리뷰"
date: "2026-06-14"
repo: "iptv-org/iptv"
repoUrl: "https://github.com/iptv-org/iptv"
...
- 오늘 트렌딩: **iptv-org/iptv** (TypeScript · ⭐ 119,389)
- 고른 이슈: **Add: Fun Vision SD** (open · 2026-06-14)
- 링크: https://github.com/iptv-org/iptv/issues/39497

## 이슈 요약 (내가 이해한 문제)

- 한 줄 요약: ### Stream ID (required) FunVision.be@SD ### Stream URL (required) https://funradiovisionhd.vedge.infomaniak.com/livecast/ik:funradiovisionhd/manifest.m3u8 ### Quality None ### Label None ### HTTP User Agent _No respons…
...
이 프로젝트는 "Collection of publicly available IPTV channels from all over the world" 쪽 문제를 건드려서 트렌딩 탔을 확률이 높고, 이슈 관리가 탄탄하면 ‘팀에 도입’까지 이어질 가능성이 큼. 현재 이 이슈의 댓글 수는 0개라서, 관심도/논의 강도를 가늠할 수 있음. 라벨은 `streams:add`가 붙어있어서 분류는 어느 정도 되어 보임. 

---

참고: https://iptv-org.github.io
